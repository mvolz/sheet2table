# OpenOffice utils. From Mitch Frazier.
...
# minor modification by mvolz, added explicit path to _oopaths for my machine
...
# Find OpenOffice.
_oopaths=(
		#this is what was in the original code
        ('/usr/lib64/ooo-2.0/program',   '/usr/lib64/ooo-2.0/program'),
        ('/opt/openoffice.org3/program', '/opt/openoffice.org/basis3.0/program'),
		#this is what works on my machine. got to be a better way to do this -mvolz
		('/usr/lib/openoffice/program','/usr/lib/openoffice/basis3.2/program'),
	)
